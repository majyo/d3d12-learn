...
HWND CreateWindowInstance(const wchar_t* windowClassName, HINSTANCE hInst,
...
void UpdateRenderTargetView(ComPtr<ID3D12Device2> device, ComPtr<IDXGISwapChain4> swapChain,
    ComPtr<ID3D12DescriptorHeap> descriptorHeap)
{
